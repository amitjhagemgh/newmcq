...
WHERE exam_portal.exam_name = 'Emotional Intelligence Test' AND users.email_id = '$email_id' AND result.status = 1
GROUP BY result.user_id, result.exam_id, result.test_series, result.test_series;";
                        // echo $query;
